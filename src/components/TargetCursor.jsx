...
export default function TargetCursor({
  ...
  const resolvedCursorColor = isLight ? '#000000' : cursorColor;
  const resolvedCursorColorOnTarget = cursorColorOnTarget || (isLight ? '#000000' : '#ffffff');
  ...
  useEffect(() => {
    ...
    const enterHandler = e => {
      ...
      if (resolvedCursorColorOnTarget) {
        gsap.to(corners, {
          borderColor: resolvedCursorColorOnTarget,
          duration: 0.15,
          ease: 'power2.out'
        });
        if (dotRef.current) {
          gsap.to(dotRef.current, {
            backgroundColor: resolvedCursorColorOnTarget,
            duration: 0.15,
            ease: 'power2.out'
          });
        }
      ...
      const leaveHandler = () => {
        ...
        if (resolvedCursorColorOnTarget && cornersRef.current) {
